                            ...
                            <?php if ( $archive_release_query->have_posts() ) : ?>
                                <div role="list" class="slider-rail swiper-wrapper">
                                    <?php while ( $archive_release_query->have_posts() ) : $archive_release_query->the_post(); ?>
                                        ...
                                        <div role="listitem" id="post-<?php the_ID(); ?>" <?php post_class( 'slider-w swiper-slide' ); ?>><a href="<?php echo esc_url( get_permalink() ); ?>" id="post-<?php the_ID(); ?>" <?php post_class( 'release-card' ); ?>> <div class="bg-tint"></div><div class="bg-gradient"></div> <img src="http://127.0.0.1:8000/wp-content/uploads/Serotonin_Cover_Clean.webphttp://127.0.0.1:8000/wp-content/uploads/Serotonin_Cover_Clean.webphttp://127.0.0.1:8000/wp-content/uploads/Brave_Cover_Clean.webphttp://127.0.0.1:8000/wp-content/uploads/Brave_Cover_Clean.webp<?php $image_id = get_field('cover_art');
